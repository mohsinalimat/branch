frappe.query_reports["General Ledger Branch"] = {
	"filters": [
		{
			"fieldname":"company",
			"label": __("Company"),
	...
	onload: function(report) {
		const views_menu = report.page.add_custom_button_group(__('Branch Wise Ledger Summary'));
...
// branch.utils.add_dimensions('General Ledger Branch', 15)