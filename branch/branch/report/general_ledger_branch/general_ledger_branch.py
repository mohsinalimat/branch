...
from branch.branch.report.financial_statements_branch import get_cost_centers_with_children
from branch.branch.report.utils import convert_to_presentation_currency, get_currency
from branch.branch.utils import get_account_currency
...
def validate_filters(filters, account_details):
	...
	if filters.get('company_branch'):
		filters.company_branch = filters.get('company_branch')
...
def get_gl_entries(filters, accounting_dimensions):
	...
	gl_entries = frappe.db.sql("""
		select
			...
			cost_center, project,company_branch,
...
def get_conditions(filters):
	...
	if filters.get("company_branch"):
		conditions.append("company_branch = %(company_branch)s")
...
def get_accountwise_gle(filters, accounting_dimensions, gl_entries, gle_map):
	...
	def update_value_in_dict(data, key, gle):
		...
		if data[key].company_branch and gle.company_branch:
			data[key].company_branch += ', ' + gle.company_branch
