...
from branch.branch.report.stock_balance_branch.stock_balance_branch import (
	get_item_details,
	get_items,
...
def get_periodic_data(entry, filters):
	...
	for d in entry:
		...
		if d.voucher_type == "Stock Reconciliation":
			if periodic_data.get(d.item_code) and periodic_data.get(d.item_code).get('balance').get(d.warehouse).get(d.company_branch):
				bal_qty = periodic_data[d.item_code]['balance'][d.warehouse][d.company_branch]
		...
		#print("Hello:::::::::::::::::",d.warehouse, value, d.company_branch);
		
		periodic_data.setdefault(d.item_code, {})
		periodic_data[d.item_code].setdefault('balance', {})
		periodic_data[d.item_code]['balance'].setdefault(d.warehouse, 0.0)
		# periodic_data[d.item_code]['balance'][d.warehouse].setdefault(d.company_branch, {})
		periodic_data[d.item_code]['balance'].setdefault(d.company_branch, 0.0)

		periodic_data.setdefault(d.item_code, {}).setdefault(period, {}).setdefault(d.warehouse, {})
		periodic_data.setdefault(d.company_branch,{})

		periodic_data[d.item_code]['balance'][d.warehouse] += value
		# print ("\n ::::::::::::::::::::ddddddddddd/;;;;;;", periodic_data)
		# print ("\n 1 ::::::::::::::::", periodic_data[d.item_code])
		# print ("\n 2 ::::::::::::::::", periodic_data[d.item_code][period])
		# print ("\n 3 ::::::::::::::::", periodic_data[d.item_code][period][d.warehouse])



		# print ("\n 4 ::::::::::::::::", periodic_data[d.item_code])
		# print ("\n 5 ::::::::::::::::", periodic_data[d.item_code]['balance'])
		# print ("\n 6 ::::::::::::::::", periodic_data[d.item_code]['balance'][d.warehouse])
		# print ("\n 7 ::::::::::::::::", periodic_data[d.item_code]['balance'][d.warehouse][d.company_branch])
