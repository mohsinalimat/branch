...
class Analytics(object):
	...
	def get_data(self):
		...
		elif self.filters.tree_type == "Company Branch":
			self.get_sales_transactions_based_on_company_branch()
			self.get_rows()	
	...
	def get_sales_transactions_based_on_company_branch(self):
		if self.filters["value_quantity"] == 'Value':
			value_field = "base_net_total as value_field"
		else:
			value_field = "total_qty as value_field"

		entity = "company_branch as entity"
