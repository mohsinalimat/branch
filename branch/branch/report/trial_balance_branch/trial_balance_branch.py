...
from branch.branch.report.financial_statements_branch import (
	filter_accounts,
...
def get_data(filters):
	...
	if filters.company_branch:
		filters.company_branch = [filters.company_branch]
...
def get_rootwise_opening_balances(filters, report_type):
	...
	if filters.company_branch:
		additional_conditions += " and company_branch = %(company_branch)s"
	...
	query_filters = {
		...
		"company_branch": filters.company_branch,
