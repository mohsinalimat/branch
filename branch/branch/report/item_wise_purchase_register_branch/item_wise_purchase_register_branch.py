...
import erpnext
from branch.branch.report.item_wise_sales_register_branch.item_wise_sales_register_branch import (
	add_sub_total_row,
	add_total_row,
	get_grand_total,
...
from branch.branch.report.item_wise_sales_history_branch.item_wise_sales_history_branch import get_item_details
...
def get_conditions(filters):
	...
	for opts in (("company", " and company=%(company)s"),
		...
		("company_branch", " and `tabPurchase Invoice`.company_branch = %(company_branch)s"),
...
def get_items(filters, additional_query_columns):
	...
	return frappe.db.sql("""
		select
			...
			`tabPurchase Invoice`.company_branch,
