...
class PartyLedgerSummaryReport(object):
	...
	def get_gl_entries(self):
		...
		self.gl_entries = frappe.db.sql("""
			select
				gle.posting_date,gle.company_branch, gle.party, gle.voucher_type, gle.voucher_no, gle.against_voucher_type,
	...
	def prepare_conditions(self):
		...
		if self.filters.company_branch:
			conditions.append("gle.company_branch=%(company_branch)s")
